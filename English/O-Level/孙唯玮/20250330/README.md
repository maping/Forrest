...
- P186-189
  - 第一段单词
    ...
    - 第三段单词
      - plead /pliːd/ v. 申辩；恳求；辩护；(在法庭)认罪；乞求；解释；为…辩护；(向法庭)陈述案情
      - visualise v. 使可视化；观察；直观显示
      - rotor blade 转子叶片；旋翼桨叶；旋翼叶片；风轮叶片；旋转叶片
      - jut /dʒʌt/ v. (使)突出，伸出 n. 突出；伸出；伸出部分
      - vibration
      - hook /hʊk/
        - n. 钩；挂钩；鱼钩；钓钩；钩拳；曲线球；吸引人的东西
        - v. (尤指用腿、胳膊、手指等)钩住，箍住；(使)钩住，挂住；钓(鱼)；打曲线球
      - sling /slɪŋ/ n. 吊索；吊带；(悬挂或起吊重物的)吊链；(悬吊受伤手臂的)悬带；投石器（旧时武器）；吊腕带；(用以背婴儿的)吊兜
        - vt. 吊；挂；(随便地)扔；遣送；驱逐；押往
      - loop /luːp/ n. 环；循环；环路；环形；(绳、电线等的)圈；（铁道或公路的）环线；环状物；圆圈；大环；循环音像磁带；循环电影胶片
        - v. 使成环；使绕成圈；成环形运动
      - anchor /ˈæŋkə(r)/ n. 锚；支柱，靠山；固定桩，系缚物；主持（电视或电台节目，尤指新闻节目）
  ...
  - 第五段单词
    - hazardous /ˈhæzədəs/ adj. 危险的；有害的（只对人有危险的）
      - hazard
    - smash /smæʃ/
      - v. 粉碎；粉碎，使破灭；（哗啦一声）打碎，打破，破碎；（用力）撞开，击穿，闯过；（使）猛烈撞击，猛烈碰撞；打高压球，猛扣
      - n. 打碎；破碎；扣球，高压球；猛击，猛撞；撞车；破灭，垮台；
    - grip /ɡrɪp/ n. 紧握；(对…的)控制，影响力；把手；了解；理解；紧抓；不打滑；旅行袋；
      - v. 紧握；抓牢；紧抓；使激动；使感兴趣；吸引住(某人)的注意；对…产生强有力的影响
    - thigh /θaɪ/ n. 大腿；股；食用的鸡(等的)大腿
  - 第六段单词
    - tilt /tɪlt/ v. 倾斜；使倾向于；(使)倾侧；偏向
